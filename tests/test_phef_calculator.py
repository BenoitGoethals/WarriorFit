...
class TestPhefCalculator(unittest.TestCase):
    ...
    def test_side_bridge_result_male_30_to_39_medium_score(self):
        ...
        a medium score.
        """
        result = PhefCalculator.side_bridge_result(85, 35, Gender.M.to_literal())  # 85 seconds equivalent
    ...
    def test_side_bridge_result_female_40_to_49_high_score(self):
        ...
        a high score.
        """
        result = PhefCalculator.side_bridge_result(100, 45, Gender.F.to_literal())  # 100 seconds equivalent to 1:40
        self.assertEqual(20, result)
    ...
    def test_side_bridge_result_male_50_plus_zero_score(self):
        ...
        """
        result = PhefCalculator.side_bridge_result(25, 55, Gender.M.to_literal())  # Time lower than minimum threshold
    ...
    def test_side_bridge_result_boundary_case_age_30(self):
        ...
        """
        result = PhefCalculator.side_bridge_result(80, 30, Gender.M.to_literal())  # Boundary age 30 falls into 30-39
    ...
    def test_side_bridge_result_boundary_case_age_40(self):
        ...
        """
        result = PhefCalculator.side_bridge_result(70, 40, Gender.F.to_literal())  # Boundary age 40 falls into 40-49
        self.assertEqual(14, result)
    ...
    def test_running_result_male_under_30_high_score(self):
        ...
        achieving a high score.
        """
        result = PhefCalculator.running_result(570, 25, Gender.M.to_literal())  # 570 seconds equivalent to 9:30
        self.assertEqual(20, result)
    ...
    def test_running_result_female_under_30_low_score(self):
        ...
        achieving a low score.
        """
        result = PhefCalculator.running_result(951, 28, Gender.F.to_literal())  # 951 seconds equivalent to ~15:51
        self.assertEqual(1, result)
    ...
    def test_running_result_male_40_to_44_medium_score(self):
        ...
        a medium score.
        """
        result = PhefCalculator.running_result(645, 42, Gender.M.to_literal())  # 645 seconds equivalent to ~10:45
    ...
    def test_running_result_female_55_to_59_high_score(self):
        ...
        a high score.
        """
        result = PhefCalculator.running_result(960, 57, Gender.F.to_literal())  # 960 seconds equivalent to ~16:00
        self.assertEqual(14, result)
    ...
    def test_running_result_boundary_age_30(self):
        ...
        """
        result = PhefCalculator.running_result(605, 30, Gender.M.to_literal())  # Boundary age 30 falls into 30-34
