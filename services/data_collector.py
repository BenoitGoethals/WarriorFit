...
class DataCollector(metaclass=Singleton):
    ...
    async def collect_tests_for_serial(self, serial: str) -> pd.DataFrame:
        ...
        # PHEF
        phef_sessions = await self._service.get_all_test_sessions_type_fitness_test(
        ...
        # Functional
        func_sessions = await self._service.get_all_test_sessions_type_fitness_test(
        ...
        # Combat
        combat_sessions = await self._service.get_all_test_sessions_type_fitness_test(
        ...
        # Swimming
        swim_sessions = await self._service.get_all_test_sessions_type_fitness_test(
